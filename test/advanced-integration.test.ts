...
describe("advanced integration: plan mutation history integrity (VAL-STATE-010, VAL-CROSS-006)", () => {
					...
					features: [
						{
							id: "f1",
							name: "F1",
							description: "Implement core feature with tests and validation for the plan mutation history",
	...
	it("re-submission from draft_review increments planVersion and records plan-revised", async () => {
		...
		const featureParams = {
			id: "f1",
			name: "F1",
			description: "Implement core feature with comprehensive tests and full validation suite",
			acceptanceCriteria: ["a"],
